...
class login(base.Page):#Page):
	...
	def login_username(self, username):
		...
		actions.move_to_element(Input1).send_keys(username).perform()
	...
	def login_password(self, password):
		...
		actions2.move_to_element(Input2).send_keys(password).perform()
	...
	user_login_success_loc = (By.XPATH, "/html/body/div[2]/div/div/div[1]/div/div/div/div/div/div/div[1]/div[2]/div/div[2]/div/div/div[1]/span[1]")
